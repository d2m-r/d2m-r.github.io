...
Informal accommodations cannot disadvantage students with formal accommodations.
...
[__You do *not* need to:__]{ .fragment}
...
![](../images/misc/why-are-you-here.jpg)
...
::: {.alert .alert-danger style="text-align: center" .fragment}
...
![The AIlephant in the room. This is DALL-E's best attempt at "An elephant with the letters A and I on its ears." Not very impressive, but I can't blame it too much. It wasn't a good pun to begin with.](../images/comics-memes/ai-lephant.png)
...
[My personal AI philosophy & Official Class Policy](d2m-r.github.io/syllabus/ai-policy.html)
...
Your engagement grade is based on how you show investment in the course and your peers, both in and out of class. 
...
Demonstrate proficiency on 12 core technical skills (standards) selecting from a [project menu](../assessment/menu.html).
...
|[**4**]{.fragment fragment-index="1"} | [**Meets Expectations**]{.fragment fragment-index="1"} | [You demonstrate the skill correctly in structured or familiar contexts.]{.fragment fragment-index="1"}|
| [**5**]{.fragment fragment-index="2"} | [**Exceeds Expectations**]{.fragment fragment-index="2"} | [You apply the skill correctly and independently in a novel context.]{.fragment fragment-index="2"} |
| [**6**]{.fragment fragment-index="3"} | [**Outstanding**]{.fragment fragment-index="3"} | [You use the skill in an especially expansive way.]{.fragment fragment-index="3"} |
...
1. Visit the menu of core standards assignments [here](../assessment/menu.html).
2. Select assignments that address the standards you want to demonstrate.
3. Use the links on the menu to create a repo within the [D2M-R GitHub organization](github.com/d2m-r) by either:
    1.  Accepting the GitHub classroom invitation (if available)
    2.  Creating a private repo from scratch and adding in the associated files from the [student hub repo](github.com/d2m-r/student-hub)
...
5. Finalize your assignment with a GitHub pull request.
6. Submit to the grading queue with the "Submit" form on the website.

:::

There are *extremely detailed* instructions for how do do each step of this process in the student-hub repo, on each submission document, and on the website. [Start here.](https://d2m-r.github.io/assessment/misc/gh-submissions.html/)
...
![](../images/screenshots/render-quarto.png){alt="Screenshot of a data project showing code chunks and narrative text in a Quarto document."}
...
| ------ | --------- | ----------- |
| [12]{.fragment fragment-index="1"} | [Core standards]{.fragment fragment-index="1"} | [Demonstrate all 12 core standards at 4pt-level or above]{.fragment fragment-index="1"} |
| [2]{.fragment fragment-index="2"} | [Reproducibility]{.fragment fragment-index="2"} | [Code is fully reproducible, with no errors]{.fragment fragment-index="2"} |
| [2]{.fragment fragment-index="3"} | [Documentation]{.fragment fragment-index="3"} | [Code is clearly commented with explanatory Quarto narrative text]{.fragment fragment-index="3"} |
| [2]{.fragment fragment-index="4"} | [Cohesion]{.fragment fragment-index="4"} | [Data wrangling, statistics, and plots are clearly connected with narrative text]{.fragment fragment-index="4"} |
| [2]{.fragment fragment-index="5"} | [Presentation]{.fragment fragment-index="5"} | [Quarto document is well-formatted and knits without error]{.fragment fragment-index="5"} |
...
If you are totally lost as to where to start, there are a few unstructured activities available in the `student-hub` repo.
...
::: {.callout-caution .bigger .fragment}
