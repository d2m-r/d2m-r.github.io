...
3. Create & edit a markdown `README.md` file
4. Create & edit an `.R` script
5. Create & edit a Quarto `.qmd` document
    1. YAML
    2. Chunk w/ `source()`
    3. Chunk w/ inline code
    4. Markdown text with inline R code
