...
-   **Accountability plans due YESTERDAY**
    -   I'm going to actually scan through them before I mark them complete, which could take a minute. So don't stress if it doesn't get "graded" for a while. It's for my own tracking, not your grade.
    -   If you have SDS accommodations, you should have them built into your plan. Still send me an email to flag it for me so I don't miss it. With the alternative assessment structure it can be easy for me to overlook
-   GitHub D2M-R
    -   *Education account is not required. It's just free and nice.*
    -   *A handful of people aren't accepting the D2M-R org invite. Please do so ASAP!*
    -   Set up your GitHub account
    -   Accept invite to a GH Classroom assignment
    -   Wait for my invite to the organization
    -   **Accept org invite**
-   RStudio + Git setup: [happygitwithr.com](https://happygitwithr.com/)
...
![](../images/screenshots/pane-files.png){style="max-height: 50%"}
![](../images/screenshots/new-project.png){style="max-height: 10em;" .fragment}
...
Keep project files connected to their projects ONLY.
Don't open files from one project while working in another, because relative paths won't work--and you need relative paths!
Top right of RStudio window shows current project name. Click to switch projects. Click the pop-out icon to open the project in a new session.
