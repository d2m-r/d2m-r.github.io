...
::: row
::: col-12
![](../images/misc/joins/full.png){style="max-height: 10em"}
:::
:::
...
::: {.r-stretch style="display: grid; grid-template-columns: repeat(3, 1fr); grid-template-rows: minmax(0, 1fr) minmax(0, 1fr); gap: 0.8em; margin-top: -2em;"}
