...
-   [Hunter's Plain English Guide to R and Some Packages](guides/hunters-r-notes.html)
    -   An attempt to turn a bunch of notes on R and some functions into language that's a bit easier to understand coming from a non-computer science perspective
