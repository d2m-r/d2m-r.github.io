...
1. **RStudio + Quarto workflow**
    ...
    - [Additional guidelines for RStudio/Quarto Workflow objective](misc/workflow-assessment.qmd)
2. **GitHub repositories and version control**
    ...
    - [Additional guidelines for GitHub/Version Control objective](misc/gh-assessment.qmd)
