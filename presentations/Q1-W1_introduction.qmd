...
- View the class climate policy [here](../syllabus/climate.qmd).
...
- View the academic integrity policy [here](../syllabus/ai-policy.qmd).
...
View the [menu](../assessment/menu.qmd).
...
1. **RStudio + Quarto workflow**
    ...
    - [Additional guidelines for RStudio/Quarto Workflow objective](../misc/github-workflow.qmd)
2. **GitHub repositories and version control**
    - Create and maintain a GitHub repo with README, .gitignore, and a commit history that reflects real work over time.
    - [Additional guidelines for GitHub/Version Control objective](../misc/github-assessment.qmd)
3. **Base R syntax and data structures**
